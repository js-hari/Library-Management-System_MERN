...
const AddNewEBook = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const promise = addNewEBook(dataToPost);
  ...
  return (
    <div className="form">
      <h3 style={{ padding: "20px" }}>ADD NEW EBOOK</h3>
      <div className="card">
        ...
        <div className="input__container__3">
          ...
          <div className="actions">
            <button className="btn btn__danger" type="button" onClick={()=>{navigate(-1)}}>Go Back</button>
